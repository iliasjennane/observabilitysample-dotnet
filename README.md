# How to troubleshoot common issues with your Azure Web Application
...
Up to this point, we have been focused on getting the application up and running within your Azure subscription. In order to learn more about how your application is performing, or to find any possible issue with your code execution, dependencies, performance, and so on, you would need to start monitoring your applications. To help with monitoring applications, the Azure Dev CLI provides a `monitor` command to help you get to the various Application Insights dashboards.
